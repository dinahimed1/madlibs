function generateMadlib() {
  ...
  var story = " You are a noun. You enjoy verb1 and verb2 with adjective1 friends. You have so much fun that you forgot about the adjective2 homework.You feel adjective3 so you leave your home. But then your parents go and find you. Once your parents find you, you look at the verb3. You look at the verb4 to find a way to escape.";
  
 // You are a (noun). YOu enjoy (verb1) and (verb2) with (adjective1) friends. You have so much fun that you forgot about the (adjective2) homework. You feel (adjective3) so you leave home. But then your  parents go and find you. Once your parents find you, you look at the (verb3). You look at the (verb4) to find a way to escape. 
  ...
  story = story.replace("adjective1", inputValue);
  
    inputValue = document.getElementById("adjective2").value;
  story = story.replace("adjective2", inputValue);
  
    inputValue = document.getElementById("adjective3").value;
  story = story.replace("adjective3", inputValue);
  ...
  story = story.replace("verb4", inputValue);
